...
dirname="/home/ethlau/projects/Power_Spectrum/halo_model_Flender/MCMC/gaussian/2019-09-26"
ofname='test.pdf'
...
fig.savefig("chains_gaussian.png")
...
fig_c.savefig("corner_gaussian.png")

best_fit_q = np.zeros(ndim)
...
with open('best_fit.param','w') as f:
    f.write
